...
echo "flatpak install io.github.flattool.Ignition page.codeberg.libre_menu_editor.LibreMenuEditor it.mijorus.gearlever -y" >> "$HOME/Desktop/InstallAllRecommended.sh"
