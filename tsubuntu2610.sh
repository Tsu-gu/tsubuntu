...
# gst-audio-thumbnailer gst-video-thumbnailer - thumbnails in nautilus
...
echo "┌──────────────────────────────────────────┐"
echo "│Making the dock slightly transparent      │"                        
echo "└──────────────────────────────────────────┘"
...
# They changed this from the previous LTS
...
wget -q $extensionsrepo/ubuntu2610setup.sh
cp ubuntu2610setup.sh $HOME/Desktop/Finish_Setup.sh
